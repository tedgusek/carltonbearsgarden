  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24 bg-green-700">
      <div className="z-10 max-w-5xl w-full font-mono text-sm flex items-center justify-center">
        <p className="fixed left-0 top-0 flex items-center w-full justify-start border-b bg-gradient-to-r from-green-300 h-24 text-5xl text-black font-extrabold md:max-w-64 md:h-64 px-10">
