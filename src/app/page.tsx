...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24 bg-green-700">
      ...
      <div className="items-end top-0 left-10 w-full bg-gradient-to-t from-white via-white dark:from-black dark:via-black lg:static lg:h-auto lg:w-auto lg:bg-none">
          <Navbar content= {content} setContent={setContent} />
        </div>
        <div className="items-end top-50 left-50 h-1/4 w-1/2 bg-green-400">
